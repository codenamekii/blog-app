<div class="pt-10 mt-10 border-t border-gray-100 comments-box">
    <h2 class="mb-5 text-2xl font-semibold text-gray-900">Diskusi</h2>
    @auth
        ...
        <button wire:click="postComment"
            class="inline-flex items-center justify-center h-10 px-4 mt-3 font-medium tracking-wide text-black transition duration-200 bg-red-600 rounded-lg hover:bg-gray-800 focus:shadow-outline focus:outline-none">
            Posting Komentar
        </button>
    @else
        <a wire:navigate class="py-1 text-yellow-500 underline" href="{{ route('login') }}"> Silahkan Login</a>
    @endauth
