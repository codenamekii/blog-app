    ...
    <div class="mb-10 w-full">
        <div class="mb-16">
            ...
            <a class="mt-10 block text-center text-lg text-yellow-500 font-semibold"
                href="http://127.0.0.1:8000/blog">Lebih Banyak...</a>
        </div>
        <hr>

        <h2 class="mt-16 mb-5 text-3xl text-yellow-500 font-bold">Postingan Terdahulu</h2>
        ...
        <a class="mt-10 block text-center text-lg text-yellow-500 font-semibold" href="http://127.0.0.1:8000/blog">Lebih Banyak...</a>
    </div>
</x-app-layout>
