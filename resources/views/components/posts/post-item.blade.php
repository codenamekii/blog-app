...
<article {{ $attributes->merge(['class' => '[&:not(:last-child)]:border-b border-gray-100 pb-10']) }}>
    <div class="grid items-start grid-cols-12 gap-3 mt-5 article-body">
        <div class="flex items-center col-span-4 article-thumbnail pe-2">
    <a wire:navigate href="{{ route('posts.show', $post->slug) }}">
        <img class="mx-auto w-full h-48 rounded-xl object-cover" src="{{ $post->getThumbnailUrl() }}" alt="thumbnail">
    </a>
</div>
